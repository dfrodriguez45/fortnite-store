...
function App() {
  ...
  return (
    <div className={`flex flex-col items-center ${loading && 'overflow-hidden h-screen'}`}>
      ...
      {loading ? <div className='animate-pulse bg-gray-700 rounded-full w-60 h-8' /> : <h3 className='text-2xl'> <CgSandClock className='inline-block animate-spin-slow' />  {remainingTime}</h3>}
